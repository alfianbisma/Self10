...
sb = LINE(token["ExvmkgVt79wYYOg8ImQ0.F9kA4xeIfhyY+fFn4Y7tea.gUCaUUzhajDLNRRUMTlJKLsw3Y+w4T7t1hApcmzQDP0="])
sb.log("Auth Token : " + str(sb.authToken))
channelToken = sb.getChannelResult()
pb1 = LINE(token["Ex6hXCQtyECpeTkPQk3e.vhFFhKOTsNM6QJ89dDc+xG.OnECI6pVLMTCYXAE6wPttU3r+Eea29nWx1MXmMui3yA="])
pb1.log("Auth Token : " + str(pb1.authToken))
pb2 = LINE(token["ExjqPhbJsJ76VxTt3Qt2.AwpDFTw29HzFUf9n7zVk8G.0F/62BPtGyra7XlQEIVcHgQZQ7bTC1mtrQQopIS9jXI="])
pb2.log("Auth Token : " + str(pb2.authToken))
pb3 = LINE(token["ExC9Oy7GXNjRTpiyZa46.2+xbdGMfVUVmaEYntevmbG.p5wiySYh/5FzmnVD4QqjCSkA4YK/eJef/xrr+68TRTw="])
pb3.log("Auth Token : " + str(pb3.authToken))
pb4 = LINE(token["ExL2BzBxqK4pJxw7bHhb.qdpQDWokSABSICqV4XF3QW.l8sZgV6sI50FSHBghUevMVGXPXjtS+O5kdnr8M4VNac="])
pb4.log("Auth Token : " + str(pb4.authToken))
pb5 = LINE(token["ExE0vhSbbHEIhn6ds7K9./bNBiRyDzlJbmoF6Rpvzoq.0lcuoYXzmDLZCOAg7AJyIyYH6GKZP2qD3qC38NmaJ8w="])
pb5.log("Auth Token : " + str(pb5.authToken))
pb6 = LINE(token["ExQht6svM7eK0VQDSvub.lqP5h9mPsVRdrezzmZkNsW.DRcVK2KsQcPTnGb0B5ZvbaqJBKU1E0CuNzUnzMPx4q0="])
pb6.log("Auth Token : " + str(pb6.authToken))
pb7 = LINE(token["ExEpwwPtEI6d0tMor5j6.m9l3c63GyIzQYyoi4jYWPG.p579lqiQY6FUK/BZrNs2+HOqaJuFiYglvDXL6v8ZB80="])
pb7.log("Auth Token : " + str(pb7.authToken))
pb8 = LINE(token["ExIaEoN2nUzuhMqdZPX7.pKSf8Bu5q1dfTqDC2fCNDW.JB3GcjXs/sJ7V2Izymzu8OgNaU67+X7Io09C5Vze+Rw="])
pb8.log("Auth Token : " + str(pb8.authToken))
pb9 = LINE(token["ExINzch66SagraQonQM9.yBEBGk8GFe8dSojVsvP56q.6DCbvOaX74JUVzhdWWTOkUzucL5poGB+aR0kI9Z1jLM="])
pb9.log("Auth Token : " + str(pb9.authToken))
pb10 = LINE(token["ExQFZTSKDjjbIPWOjF89.OxiGyomjGfJ2WObN+Hja/q.AIqha3q/SVEPwX0YrckSUwb1z3Yt7CjHUPXh79rWuVw="])
